...
public class Cliente implements Serializable {
	...
	// Coloca como Integer, e no fields coloca como TipoCliente
	private Integer tipo;
	
	@JsonManagedReference // Proteção contra serialização
	@OneToMany(mappedBy="cliente") // Mapendo com o campo cliente
	private List<Endereco> enderecos = new ArrayList<>(); // Relação um para muitos
	...
	public TipoCliente getTipo() {
		return TipoCliente.toEnum(tipo); // Chamando a função salva em TipoCliente
	}
